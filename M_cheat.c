...
// killough 2/7/98: simplified using boom_printf and made output more user-friendly
static void cheat_mypos()
{
  boom_printf("Position (%d,%d,%d)\tAngle %-.0f", 
...
static void cheat_massacre()    // jff 2/01/98 kill all monsters
{
  ...
  //
  // killough 2/7/98: cleaned up code and changed to use boom_printf;
  ...
  boom_printf("%d Monster%s Killed", killcount, killcount==1 ? "" : "s");
}
